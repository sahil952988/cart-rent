  ...
  return (
    <>
      <Slider {...settings} className="w-[100%] md:h-[650px] h-[450px] overflow-hidden">
        <div className="slider__item-01 mt-[-50px] pt-[20px]  md:h-[650px] h-[450px]">
          <div>
        ...
        <div className="slider__item-02 mt-[-50px]  md:h-[650px] h-[650px]">
          <div>
            <div className="slider__content md:pl-[120px] pt-[20px] pl-5">
              <h4 className="md:text-[24px] text-[22px] text-white md:pt-[200px] pt-[100px]">For Rent $70 Per Day</h4>
              <h1 className="md:text-[51.2px] text-[24px] text-white pt-5">Reserve Now and Get 50% Off</h1>
        ...
        <div className="slider__item-03 mt-[-50px]  md:h-[650px] h-[650px]">
          <div>
            <div className="slider__content md:pl-[120px] pt-[20px] pl-5">
              <h4 className="md:text-[24px] text-[22px] text-white md:pt-[200px] pt-[100px]">For Rent $70 Per Day</h4>
              <h1 className="md:text-[51.2px] text-[24px] text-white pt-5">Reserve Now and Get 50% Off</h1>
